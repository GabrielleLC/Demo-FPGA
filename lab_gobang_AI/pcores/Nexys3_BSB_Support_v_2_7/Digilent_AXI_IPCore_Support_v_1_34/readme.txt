...
Software: Xilinx EDK 13.2 to 14.4
...
2. Linux   1. Copy the content of the ../Digilent_AXI_IPCore_Support_v_1_34/ipxact/busdefs 
			  directory to $XILINX/EDK/data/wizards/ipxact/busdefs, 
			  where $XILINX is the XIlinx ISE Software installation path
		   2. Copy the content of the ../Digilent_AXI_IPCore_Support_v_1_34/ipxact/hurri/xilinx.com/
			  directory to $XILINX/EDK/data/wizards/ipxact/hurri/xilinx.com
		   3. Copy the content of the ../Digilent_AXI_IPCore_Support_v_1_34/ipxact/pcores/
